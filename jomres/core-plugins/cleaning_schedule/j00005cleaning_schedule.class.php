...
class j00005cleaning_schedule {
	function __construct()
		...
		$obsolete_plugin_files[] = get_showtime('ePointFilepath').'j00013schedule.class.php';
		$obsolete_plugin_files[] = get_showtime('ePointFilepath').'j06000cleaning_schedule.class.php';
