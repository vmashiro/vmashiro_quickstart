...
class j16000jintour_tourprofiles
	...
	function __construct()
		...
		$output['HREPEATING']= jr_gettext('_JINTOUR_PROFILE_REPEATING',_JINTOUR_PROFILE_REPEATING,false) ;
		...
		if (count($all_profiles)>0)
			...
			foreach ($all_profiles as $p)
				...
				if ($p['repeating']=="1")
					$r['REPEATING']=jr_gettext('_JOMRES_COM_MR_YES',_JOMRES_COM_MR_YES,false);
				else
					$r['REPEATING']=jr_gettext('_JOMRES_COM_MR_NO',_JOMRES_COM_MR_NO,false);
