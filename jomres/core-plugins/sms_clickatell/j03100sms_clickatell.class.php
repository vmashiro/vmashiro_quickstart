...
class j03100sms_clickatell 
	...
	function __construct($componentArgs)
		...
		if (count($rmids) > 0 )
			{
			$query="SELECT propertys_uid,room_number,room_name FROM #__jomres_rooms WHERE room_uid IN (".implode(',',$rmids).") ";
		...
		$subject=jr_gettext("_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE",_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE).stripslashes($propertyName);
