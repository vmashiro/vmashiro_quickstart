			...
			var live_site_ajax = "http://localhost/quickstart/index.php?action=jomres/trigger.php&no_html=1&jrajax=1&jr_wp_source=frontend&option=com_jomres&page_id=4";
			var compare_url = "http://localhost/quickstart/index.php?option=com_jomres&page_id=4&task=compare";
			var path_to_jomres_dir = "http://localhost/quickstart";
			var module_pop_ajax_url = "http://localhost/quickstart/index.php?action=jomres/trigger.php&no_html=1&jrajax=1&jr_wp_source=frontend&option=com_jomres&page_id=4&task=module_popup&nofollowtmpl=1&id=";
			
			var jomres_template_version = "bootstrap";
			var property_reviews_ajax_url = "http://localhost/quickstart/index.php?action=jomres/trigger.php&no_html=1&jrajax=1&jr_wp_source=frontend&option=com_jomres&page_id=4&task=show_property_reviews&nofollowtmpl=1&property_uid=";
