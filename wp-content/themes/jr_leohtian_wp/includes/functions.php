 ...
 * @filesource     wp-content/themes/strappress/includes/functions.php
...
function responsive_breadcrumb_lists() {
	...
	/**
	 * jr_leohtian_wp_less function.
	 * Load less for development or even on the running website. If you want to use less just enable this function
	 * @access public
	 * @return void
	 */
	function jr_leohtian_wp_less() 
		{
		printf('<link rel="stylesheet" type="text/less" href="%s" />', get_template_directory_uri().'/less/theme.less?ver=1'); 
	...
	//if (!is_admin())
		//{
		//add_action('wp_head', 'jr_leohtian_wp_less');
		//}
    ...
    function responsive_widgets_init() {
        ...
        register_sidebar(array(
            ...
            'after_title' => '</h3></span><div class="module-ct">',
            'before_widget' => '<div class="t3-module module"><div class="module-inner"><div id="%1$s" class="widget-wrapper %2$s">',
        ...
        register_sidebar(array(
            ...
            'after_title' => '</h3></div>',
            'before_widget' => '<div class="wrap t3-sl t3-sl-1"><div id="%1$s" class="%2$s">',
        ...
        register_sidebar(array(
            ...
            'description' => __('Area Six - sidebar-home.php', 'responsive'),
            'id' => 'home-widget-2',
            'before_title' => '<div id="widget-title-two" class="row-feature"><h3 class="row-feature-title"><span>',
            'after_title' => '</span></h3></div><div class="row row-feature-ct">',
            'before_widget' => '<div class="wrap t3-sl t3-sl-3"><div class="container"><div class="row-feature"><div id="%1$s" class="%2$s">',
        ...
        register_sidebar(array(
            ...
            'description' => __('Area Six - sidebar-home.php', 'responsive'),
            'id' => 'home-widget-3',
            'before_title' => '<div id="widget-title-three" class="row-feature"><h3 class="row-feature-title"><span>',
            'after_title' => '</span></h3></div><div class="row row-feature-ct">',
            'before_widget' => '<div class="wrap t3-sl t3-sl-3"><div class="container"><div class="row-feature"><div id="%1$s" class="%2$s">',
            'after_widget' => '</div></div></div></div></div>'
        ));
		...
		register_sidebar(array(
            ...
            'description' => __('Area Six - sidebar-home.php', 'responsive'),
            'id' => 'home-widget-4',
            'before_title' => '<div id="widget-title-four" class="row-feature"><h3 class="row-feature-title"><span>',
            'after_title' => '</span></h3></div><div class="row row-feature-ct">',
            'before_widget' => '<div class="wrap t3-sl t3-sl-3"><div class="container"><div class="row-feature"><div id="%1$s" class="%2$s">',
            'after_widget' => '</div></div></div></div></div>'
        ));
		...
		register_sidebar(array(
            ...
            'after_title' => '</h3></div>',
            'before_widget' => '<div class="wrap t3-sl t3-sl-5"><div id="%1$s" class="%2$s">',
            'after_widget' => '</div></div>'
        ));
		
		register_sidebar(array(
            'name' => __('Home Widget Search', 'responsive'),
            'description' => __('Area Six - sidebar-home.php', 'responsive'),
            'id' => 'home-widget-search',
            'before_title' => '<div id="widget-title-home-search" class="widget-title-home"><h3>',
            'after_title' => '</h3></div>',
            'before_widget' => '<div class="wrap t3-sl t3-sl-search clearfix"><div class="container"><div id="%1$s" class="%2$s">',
            'after_widget' => '</div></div></div>'
        ));
		
		register_sidebar(array(
            'name' => __('Home Call To Action 1', 'responsive'),
            'description' => __('Area Six - sidebar-home.php', 'responsive'),
            'id' => 'home-call-1',
            'before_title' => '<div id="widget-title-call-1" class="widget-title-home"><h3>',
            'after_title' => '</h3></div>',
            'before_widget' => '<div class="wrap call-to-action1"><div class="container"><div id="%1$s" class="%2$s">',
            'after_widget' => '</div></div></div>'
        ));
		
		register_sidebar(array(
            'name' => __('Home Call To Action 2', 'responsive'),
            'description' => __('Area Six - sidebar-home.php', 'responsive'),
            'id' => 'home-call-2',
            'before_title' => '<div id="widget-title-call-2" class="widget-title-home"><h3>',
            'after_title' => '</h3></div>',
            'before_widget' => '<div class="wrap call-to-action2"><div class="container"><div id="%1$s" class="%2$s">',
            'after_widget' => '</div></div></div>'
        ));
		
		register_sidebar(array(
            'name' => __('Home Call To Action 3', 'responsive'),
            'description' => __('Area Six - sidebar-home.php', 'responsive'),
            'id' => 'home-call-3',
            'before_title' => '<div id="widget-title-call-3" class="widget-title-home"><h3>',
            'after_title' => '</h3></div>',
            'before_widget' => '<div class="wrap call-to-action3"><div class="container"><div id="%1$s" class="%2$s">',
            'after_widget' => '</div></div></div>'
        ));
		
		register_sidebar(array(
            'name' => __('Home Call To Action 4', 'responsive'),
            'description' => __('Area Six - sidebar-home.php', 'responsive'),
            'id' => 'home-call-4',
            'before_title' => '<div id="widget-title-call-4" class="widget-title-home"><h3>',
            'after_title' => '</h3></div>',
            'before_widget' => '<div class="wrap call-to-action4"><div class="container"><div id="%1$s" class="%2$s">',
            'after_widget' => '</div></div></div>'
        ));

        register_sidebar(array(
            'name' => __('Contact', 'responsive'),
            'description' => __('Area Seven - contact.php', 'responsive'),
            'id' => 'contact-widget',
            'before_title' => '<div id="widget-title-contact"><h3 class="module-title"><span>',
           'after_title' => '</span></h3></div><div class="module-ct">',
            'before_widget' => '<div class="t3-module module"><div class="module-inner"><div id="%1$s" class="%2$s">',
            'after_widget' => '</div></div></div></div>'
        ));
		
		register_sidebar(array(
            'name' => __('Footer Widget 1', 'responsive'),
            'description' => __('Area Eight - footer.php', 'responsive'),
            'id' => 'footer-widget-1',
            'before_title' => '<div id="footer-widget-title-1"><h3 class="module-title"><span>',
            'after_title' => '</span></h3></div><div class="module-ct">',
            'before_widget' => '<div class="t3-module module"><div class="module-inner"><div id="%1$s" class="%2$s">',
            'after_widget' => '</div></div></div></div>'
        ));
		...
		register_sidebar(array(
            ...
            'description' => __('Area Eight - footer.php', 'responsive'),
            'id' => 'footer-widget-2',
            'before_title' => '<div id="footer-widget-title-2"><h3 class="module-title"><span>',
            'after_title' => '</span></h3></div><div class="module-ct">',
            'before_widget' => '<div class="t3-module module"><div class="module-inner"><div id="%1$s" class="%2$s">',
            'after_widget' => '</div></div></div></div>'
        ));
		...
		register_sidebar(array(
            ...
            'description' => __('Area Eight - footer.php', 'responsive'),
            'id' => 'footer-widget-3',
            'before_title' => '<div id="footer-widget-title-3"><h3 class="module-title"><span>',
            'after_title' => '</span></h3></div><div class="module-ct">',
            'before_widget' => '<div class="t3-module module"><div class="module-inner"><div id="%1$s" class="%2$s">',
            'after_widget' => '</div></div></div></div>'
        ));
		...
		register_sidebar(array(
            ...
            'description' => __('Area Eight - footer.php', 'responsive'),
            'id' => 'footer-widget-4',
            'before_title' => '<div id="footer-widget-title-4"><h3 class="module-title"><span>',
            'after_title' => '</span></h3></div><div class="module-ct">',
            'before_widget' => '<div class="t3-module module"><div class="module-inner"><div id="%1$s" class="%2$s">',
            'after_widget' => '</div></div></div></div>'
        ));
		...
		register_sidebar(array(
            'name' => __('Spotlight Widget 1', 'responsive'),
            'description' => __('Area Nine - template-jomres.php', 'responsive'),
            'id' => 'spotlight-widget-1',
            'before_title' => '<div id="spotlight-widget-title-1"><h3 class="module-title"><span>',
            'after_title' => '</span></h3></div><div class="module-ct">',
            'before_widget' => '<div class="t3-module module"><div class="module-inner"><div id="%1$s" class="%2$s">',
            'after_widget' => '</div></div></div></div>'
        ));
