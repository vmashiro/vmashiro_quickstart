...
function bootstrap_scripts()
{
	...
	wp_register_script( 'waypoints-script', get_template_directory_uri() . '/js/waypoints.min.js', array( 'jquery' ) );
...
function bootstrap_styles()
{
	...
	//wp_register_style( 'bootstrap-styles', get_template_directory_uri() .'/css/layouts/' . bi_option('bootswatch'), array(), '3.3.5', 'all' );
	wp_register_style( 'bootstrap-styles', get_template_directory_uri() .'/css/bootstrap.min.css', array(), '3.3.5', 'all' );
	...
	wp_register_style( 'animate', get_template_directory_uri() . '/css/animate.css', array(), '0.9.4', 'all' );
    wp_register_style( 'responsive-style', get_stylesheet_uri(), false, '3.3.5' );
...
/**
 * This function adds the Camera Slideshow scripts so the slideshow will work in widgets too
 */
/*if (function_exists('camera_meta_slideshow'))
	{
	add_action( 'wp_enqueue_scripts', 'cameraSlideshow_scripts' );
	add_action( 'wp_enqueue_scripts', 'cameraSlideshow_styles' );
	}

function cameraSlideshow_styles()
	{
...
function cameraSlideshow_scripts()
	{
	global $pix_plugindir;
